...
ROOT_URLCONF = 'wmtha_project.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            os.path.join(BASE_DIR, 'wmtha_project/templates'),
...
WSGI_APPLICATION = 'wmtha_project.wsgi.application'
